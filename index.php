...
add_action('wp_enqueue_scripts', '\Arrigoo\WpCdpBlockControl\EndUser::arrigoo_cdp_enqueue_assets');
add_action('wp_head', '\Arrigoo\WpCdpBlockControl\EndUser::arrigoo_cdp_print_styles');
...
add_action('admin_menu', '\Arrigoo\WpCdpBlockControl\AdminSettings::register_admin_menu');
add_action('admin_init', '\Arrigoo\WpCdpBlockControl\AdminSettings::register_settings');